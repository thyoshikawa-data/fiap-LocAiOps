...
export default function Dashboard({ data }: { data: DashboardData }) {
  ...
  const produtoSegments = segments.opcoes
    .filter((o) => o.tipo === "produto" && o.valor)
    .map((o) => ({ key: o.valor as string, seg: segments.dados[o.id] }));
        ...
        {tab === "overview" && (
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-[#E4E0DC] bg-white p-4 shadow-sm">
              ...
              {segmentId === "todos" ? (
                <StackedVolumeChart todos={activeSegment} produtos={produtoSegments} />
              ) : (
